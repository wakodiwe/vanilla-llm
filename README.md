...
VanillaLLM is a single-file (~200 lines) module that wraps the OpenAI-compatible chat completion endpoint. Supports Ollama, llama.cpp, and any OpenAI-compatible server.
